#!/usr/bin/env python                                            
#
# pfdorun_imgmagick ds ChRIS plugin app
#
...
Gstr_title = """
       ...
       _               __    _                          _                                       _      _    
      | |             / _|  | |                        (_)                                     (_)    | |   
 _ __ | |______ _ __ | |_ __| | ___  _ __ _   _ _ __    _ _ __ ___   __ _ _ __ ___   __ _  __ _ _  ___| | __
| '_ \| |______| '_ \|  _/ _` |/ _ \| '__| | | | '_ \  | | '_ ` _ \ / _` | '_ ` _ \ / _` |/ _` | |/ __| |/ /
| |_) | |      | |_) | || (_| | (_) | |  | |_| | | | | | | | | | | | (_| | | | | | | (_| | (_| | | (__|   < 
| .__/|_|      | .__/|_| \__,_|\___/|_|   \__,_|_| |_| |_|_| |_| |_|\__, |_| |_| |_|\__,_|\__, |_|\___|_|\_\\
| |            | |                                 ______            __/ |                 __/ |            
|_|            |_|                                |______|          |___/                 |___/             

"""

class Pfdorun_imgmagick(ChrisApp):
    """
    An app to ....
    """
    ...
    def define_parameters(self):
        ...
        # self.add_argument('--json', dest='json', type=bool, action='store_true',
        #                   default=False, optional=True, help='output final return in json')
    ...
    def show_man_page(self, ab_shortOnly=False):
        ...
        DESCRIPTION
            ...
            `pfdorun_imgmagick.py` recursively walks down a directory tree and runs a CLI program
